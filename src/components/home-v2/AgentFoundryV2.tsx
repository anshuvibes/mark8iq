              ...
              >
                ...
                {activePersona.type === 'standard' && (
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: activePersona.id === 'ads' ? '16px' : '10px' }}>
                      ...
                      <span style={{ fontFamily: "'Saira', sans-serif", fontSize: '12px', color: 'var(--v2-text-muted)' }}>
                        Last action: {activePersona.lastAction}
                      </span>
                    </div>
                    {activePersona.id === 'ads' && (
                    ...
                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginTop: activePersona.id === 'ads' ? '14px' : 0 }}>
                      {activePersona.connects.map((tag) => (
                        <span key={tag} style={{
                          fontFamily: "'Saira', sans-serif",
                          fontSize: '11px',
                          padding: '3px 10px',

...
const stories = [
  {
    ...
    logo: 'https://admin.infytrix.info/uploads/myntra_0ef843ae4c.svg',
    logoW: 133,
    logoH: 36,
  ...
  },
  {
    ...
    company: 'Flipkart',
    quote: 'Lorem ipsum dolor sit amet consectetur. Accumsan tellus a amet sodales ultrices ipsum. Sed vel consectetur interdum semper vestibulum. Arcu posuere pellentesque nunc egestas viverra viverra tristique platea ante. Sed vel consectetur interdum semper vestibulum.',
    logo: 'https://admin.infytrix.info/uploads/flipkart_02bb484171.svg',
    logoW: 164,
    logoH: 43,
    img: 'https://infytrix.info/_next/image?url=https%3A%2F%2Fadmin.infytrix.info%2Fuploads%2Fdummy_4610990c7b.webp&w=640&q=75',
  },
    ...
    <section className="section_spacing">
      <div className="HomeStories_HomeStories__V3PkK">
        <div className="container">
          ...
          {/* Brand Logo Slider */}
          <div className="HomeStories_brand_slider__rpqsc fadeInUp" data-scroll="in">
              ...
              <div className="slick-list">
                <div className="slick-track" style={{ width: `${stories.length * 209}px`, opacity: 1, transform: 'translate3d(0px, 0px, 0px)' }}>
                  {stories.map((story, i) => (
                    ...
                    >
                      <div>
                        <div className="HomeStories_brand_logo_item__vsM6F" tabIndex={-1} style={{ width: '100%', display: 'inline-block' }}>
          ...
          {/* Story Cards */}
          <div className="undefined m_t_40 fadeInUp" data-scroll="in">
            <div className="slick-slider slick-initialized" dir="ltr">
              <div className="slick-list">
                <div className="slick-track" style={{ width: `${stories.length * 1210}px`, opacity: 1, transform: `translate3d(-${activeSlide * 1210}px, 0px, 0px)`, transition: 'transform 0.3s ease' }}>
                  {stories.map((story, i) => (
                    <div
                      key={i}
                      data-index={i}
